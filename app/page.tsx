...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-gray-900 dark:text-gray-100 font-inter transition-colors duration-300">
      <main className="flex flex-row items-center justify-center flex-1 w-full px-4 max-w-5xl mx-auto gap-16">
        {/* Profile Image */}
        <div className="h-80 w-80 rounded-xl shadow-xl overflow-hidden shrink-0">
          <Image
        ...
        <div className="flex flex-col items-start justify-center w-full max-w-xl">
          ...
          <div
            className={`text-xl mb-2 text-gray-100 transition-opacity duration-200 ${bioFade ? "opacity-100" : "opacity-0"}`}
