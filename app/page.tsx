  ...
  return (
    <div className="min-h-screen flex flex-col text-foreground font-inter">
      ...
      <main className="flex flex-col md:flex-row items-center justify-center flex-1 w-full px-4 max-w-5xl mx-auto gap-10 md:gap-20 py-12 md:py-24">
        ...
        >
          <div
            className="h-40 w-40 md:h-52 md:w-52 rounded-full ring-1 ring-foreground/10 overflow-hidden shadow-2xl cursor-default"
            style={{
        ...
        >
          ...
          <p className="text-[11px] font-medium tracking-[0.2em] uppercase text-foreground/35 mb-8">
          ...
          {/* Nav */}
          <div className="flex gap-6 text-foreground/35">
